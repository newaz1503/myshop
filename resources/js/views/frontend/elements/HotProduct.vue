        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-md-12">
                    <div class="card card-height-100 bg-transparent shadow-none p-xs-10">
                        <div class="card-header align-items-center d-flex  title_shape  ps-0">
                            <h4 class="card-title mb-0 flex-grow-1 ps-0">Hot Products</h4>
                        ...
                        <div class="card-body ps-0 pe-0">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    id="swiper-wrapper-d35f1b55cc21006fa"
                                    aria-live="off"
                                    style="transform: translate3d(-539px, 0px, 0px); transition-duration: 300ms;">
                                    <div
                                        class="swiper-slide"
                                        style="max-width: 16.6666666667%; margin-right: 20px;"
                                        role="group"
                                        aria-label="1 / 4">
                                        <div class="col-lg-12">
                                            <div class="card ribbon-box ribbon-fill shadow-sm  card-height-100">
                                                <div class="ribbon-two ribbon-two-primary">
                                                    <span class=" bg-color">Hot</span>
                                                </div>
                                                            ...
                                                            <div class="d-flex align-items-center gap-2 text-muted">
                                                                <a href="#" title="Add to cart"
                                                                   class="d-block text-body">
                                                                    <i class="text-color bx bx-shopping-bag align-bottom me-1 fs-15"></i>
                                                                </a>
                                                                <a href="#" title="Compare"
                                                                   class="d-block text-body">
                                                                    <i class="text-color   bx bx-refresh align-bottom me-1 fs-15"></i>
                                                                </a>
                                                                <a href="#" title="Wishlist"
                                                                   class="d-block text-body">
                                                                    <i class="text-color bx bx-heart align-bottom me-1 fs-15"></i>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
