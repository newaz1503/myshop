...
<script>
    ...
    const tableColumns = [
        {field: "image", title: "Image", image: true, height: '40px', width: '40px'},
        {field: "parent", title: "Category", subfield:'title'},
        {field: "sub_categories", title: "Sub Category", subfield:'title'},
